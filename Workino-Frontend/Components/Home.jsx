...
const image2 = {
  uri: "https://images.unsplash.com/photo-1609114215069-74764924d06b?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
};
    ...
    <>
      ...
      <View style={styled.mainContainer} horizontal={true}>
        ...
        >
          ...
          />
          <Text className="text-white text-center mt-4" style={styled.text}>
            Utensil washing
          </Text>
        </Pressable>
        <Pressable
